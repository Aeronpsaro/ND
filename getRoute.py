...
minWidthCenter = 25 #Tamaño mínimo del robot para que no tenga que ir por el centro
...
# - valley: tupla que contiene donde empieza y donde acaba el valle
...
def getRoute(valley, north):
    ...
    if (north < valley[1][0] and north > valley[0][0]):
        ...
        if (valleyWidth < minWidthCenter):
            return (valley[1][0] + valley[0][0]) / 2
